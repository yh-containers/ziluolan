...
//        $actions = array_merge($actions,$mer);
        ...
        $action_id = str_replace($controller_id.'/','',\Yii::$app->requestedRoute);//\Yii::$app->controller->action->id;
        $ignore_action = ['show-list','detail'];
        if(!in_array($action_id,$ignore_action) && !array_key_exists($action_id,$actions)){
            $actions = array_merge($actions,[
                $action_id=>[
                    'class'=>'frontend\components\ArticleAction',
                ]
            ]);
        }
